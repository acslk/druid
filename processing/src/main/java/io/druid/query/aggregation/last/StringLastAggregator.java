...
public class StringLastAggregator implements Aggregator
{
  ...
  public StringLastAggregator(String name, LongColumnSelector timeSelector, DimensionSelector valueSelector)
  {
    this.name = name;
  ...
  public void aggregate()
  {
    ...
    if (time >= lastTime) {
      ...
      lastValue = row.size() == 0 ? "" : valueSelector.lookupName(row.get(0));
    }
  }
