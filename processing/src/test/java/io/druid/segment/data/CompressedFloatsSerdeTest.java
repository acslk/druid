...
public class CompressedFloatsSerdeTest
{
  ...
  public static Iterable<Object[]> compressionStrategies()
  {
    ...
    for (CompressionFactory.FloatEncodingStrategy encodingStrategy: CompressionFactory.FloatEncodingStrategy.values()) {
  ...
  protected final CompressionFactory.FloatEncodingStrategy encodingStrategy;
  ...
  public CompressedFloatsSerdeTest(
      CompressionFactory.FloatEncodingStrategy encodingStrategy,
  ...
  {
    FloatSupplierSerializer serializer = CompressionFactory.getFloatSerializer(new IOPeonForTesting(), "test", order,
