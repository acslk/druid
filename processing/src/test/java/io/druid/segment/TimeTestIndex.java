...
public class TimeTestIndex
{
  ...
  public static final String[] METRICS = new String[]{"value1"};
  private static final Logger log = new Logger(TestIndex.class);
  private static final Interval DATA_INTERVAL = new Interval("2016-01-01T00:00:00.000Z/2016-01-02T00:00:00.000Z");
  public static final AggregatorFactory[] METRIC_AGGS = new AggregatorFactory[]{
      new LongSumAggregatorFactory(METRICS[0], METRICS[0]),
      new HyperUniquesAggregatorFactory("quality_uniques", "name")
  };
  ...
  public static IncrementalIndex getIncrementalTestIndex()
  {
    ...
    return realtimeIndex = makeRealtimeIndex("druid.time.tsv");
  }
  ...
  public static IncrementalIndex getNoRollupIncrementalTestIndex()
  {
    ...
    return noRollupRealtimeIndex = makeRealtimeIndex("druid.time.tsv", false);
  }
