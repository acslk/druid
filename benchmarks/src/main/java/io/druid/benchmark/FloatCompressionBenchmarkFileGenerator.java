...
public class FloatCompressionBenchmarkFileGenerator
{
  ...
  public static final List<CompressionFactory.FloatEncodingStrategy> encodings =
      ImmutableList.of(CompressionFactory.FloatEncodingStrategy.FLOATS);
  ...
  public static void main(String[] args) throws IOException, URISyntaxException
  {
    ...
    for (Map.Entry<String, BenchmarkColumnValueGenerator> entry : generators.entrySet()) {
      for (CompressedObjectStrategy.CompressionStrategy compression : compressions) {
        for (CompressionFactory.FloatEncodingStrategy encoding : encodings) {
